export default function Privacy() {
  return (
    <section className="relative bg-[#0c1650] h-screen overflow-hidden pt-16">
      <div className="max-w-6xl mx-auto relative py-12 md:py-20 px-4 text-white">
        ...
        <p>
          ...
          Application, please contact the Service Provider via email at
          carptracker.app@gmail.com.
        </p>
